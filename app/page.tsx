...
import { membership_plans, price_plans, programs, testimonial_rate, testimonials, trainer_stats, trainers } from "./data";
    ...
    <>
      ...
      <div className="w-full relative h-[100vh] flex items-center justify-center">
          ...
          <div className="w-full h-full absolute inset-o bg-black/70 top-0 left-0 flex flex-col items-center justify-center">
            <div className="w-auto flex space-x-5 p-2 mt-25">
            ...
            <h3 className="heading w-[50%] mt-10 text-center text-white text-[55px] font-bold leading-tight">TRANSFORM YOUR BODY. <br /> <span className="text-[#55FFCB]">UNLOCK YOUR STRENGTH.</span></h3>
            <p className="w-[55%] mt-8 text-center text-white/90">Elite training programs, certified coaches, and a community built to help you win. Whether you're starting 
              your fitness journey or pushing to the next level, IronCore is where transformation happens.
            </p>
            <div className="flex items-center space-x-5 mt-5 ">
              <Link href="#" className="px-7 py-3 text-[13px] rounded-full text-[#0A0A0A] bg-[#55FFCB] font-bold">
                  Join Now
              </Link>
              <Link href="#" className="px-7 py-3 text-[13px] border-2 border-white rounded-full text-white font-bold">
                  Book Free Session
              </Link>
            </div>
            <div className="w-auto p-5  mt-5 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-5">
              {stats.map((data) => (
                <div className="flex flex-col items-center py-3.5 px-6 border-1 bg-[#070A0C] border-[#55FFCB]/20 rounded-xl">
      ...
      <div className="w-full px-10 py-20 bg-[#242424] flex space-x-10">
          <div className="w-1/2 p-5 flex items-center justify-center mt-5 relative overflow-hidden">
              <img src="/hero.jpg" alt="" className="w-full h-[80%] rounded-xl object-cover" />
              <div className="absolute w-[80%] top-[70%] p-5 flex items-center space-x-5">
          ...
          <div className="w-1/2 flex flex-col items-left p-5 justify-center mt-5">
              <p className="text-[12px] font-bold text-[#55FFCB]">ABOUT IRONCORE FITNESS</p>
              <h3 className="text-4xl heading leading-tight font-bold mt-3 text-white">MORE THAN A GYM. <br /> <span className="text-[#55FFCB]">A TRANSFORMATION HUB</span></h3>
              <div className="w-full flex flex-col space-y-2 mt-5 text-[13px] text-white/80">
                <p>At IronCore Fitness, we believe fitness is more than just lifting weights or running  ona treadmill. It's about building confidence,
              ...
              <div className="mt-5 p-2 w-full grid grid-cols-1 sm:grid=cols-1 md:grid-cols-2 gap-5">
                {about.map((data) => (
              ...
              <div className="w-full flex space-x-5 items-center mt-5">
                  <Link href="#" className="px-6 py-3 bg-[#55FFCB] text-[#0A0A0A] rounded-full font-bold text-[12px]">
                    Learn More About Us
                  </Link>
                  <Link href="#" className="px-6 py-3 bg-transparent text-white rounded-full font-bold text-[12px] border-2 border-[#55FFCB]">
                    Meet Our Trainers
                  </Link>
              </div>
          </div>
      ...
      <div className="w-full p-15 flex flex-col items-center bg-[#0A0B0B]">
          <p className="text-[12px] font-bold text-[#55FFCB]">OUR PROGRAMS</p>
          <h3 className="text-4xl heading leading-tight text-center font-bold mt-3 text-white">PROGRAM DESIGNED<br /> <span className="text-[#55FFCB]">FOR YOUR SUCCESS</span></h3>
          ...
          <div className="w-full mt-5 p-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {programs.map((data, index) => {
                ...
                return(
                  <div key={index} className="w-full p-6 border-1  bg-[#2A2A2A] hover:border-2 border-[#55FFCB]/20 flex flex-col rounded-xl bg-[#242424] transition-all ">
      ...
      <div className="w-full p-15 flex flex-col items-center bg-[#242424]">
          <p className="text-[12px] font-bold text-[#55FFCB]">MEMEBERSHIP PLANS</p>
          <h3 className="text-4xl heading leading-tight text-center font-bold mt-3 text-white">FLEXIBLE PLANS.<br /> <span className="text-[#55FFCB]">ZERO COMMITMENT</span></h3>
          <p className="w-[50%] text-center text-[13px] text-white/80 mt-5">
          ...
          <div className="w-full py-5 mt-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {membership_plans.map((data, index) => {
                ...
                return (
                  <div key={index} className="p-5 border-1 border-[#55FFCB]/20 bg-[#2A2A2A] hover:bg-transparent transition-all  flex flex-col items-center rounded-xl group">
                    ...
                    <h3 className="text-sm font-bold text-white mt-4">{data.title}</h3>
          ...
          <div className="w-full py-5 mt-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-5 space-x-5">
              {price_plans.map((data, index) => {
                ...
                return (
                  <div key={index} className={`relative p-6 rounded-2xl transition-all duration-300 bg-[#2A2A2A] flex flex-col items-center ${most_popular ? "border-2 border-[#55FFCB] scale-103 shadow-[0_0_30px_rgba(85,255,203,0.2)]" : "border-1 border-[#55FFCB]/20"}`}>
                    {most_popular &&(
                    ...
                    <a href="#" className={`w-[90%]  mt-6 rounded-full text-center text-[12px] font-semibold px-5 py-3  ${data.type === "Standard" ? "bg-[#55FFCB]" : "border-2 border-[#55FFCB] text-white"  }`}>Choose {data.type}</a>

                  </div>
                )
              })}
          </div>
          <div className="w-full p-5 flex flex-col items-center space-y-5 bg-[#2A2A2A] border-1 border-[#55FFCB]/20 rounded-xl mt-10">
              ...
              <div className="w-auto flex space-x-5 items-center">
                <Link href="#" className="px-6 py-3 bg-[#55FFCB] text-[#0A0A0A] rounded-full font-bold text-[12px]">
                  View All Plans
                </Link>
                <Link href="#" className="px-6 py-3 bg-transparent text-white rounded-full font-bold text-[12px] border-2 border-[#55FFCB]">
      ...
      <div className="w-full p-15 flex flex-col items-center bg-[#0A0B0B]">
          <p className="text-[12px] font-bold text-[#55FFCB]">OUR EXPERT TEAM</p>
          <h3 className="text-4xl heading leading-tight text-center font-bold mt-3 text-white">MEET YOUR <br /> <span className="text-[#55FFCB]">TRANSFORMATION COACHES</span></h3>
          <p className="w-[50%] text-center text-[13px] text-white/80 mt-5">
          ...
          <div className="w-full py-5 mt-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {trainers.map((data, index) => (
                <div key={index} className="w-full flex flex-col border-1 border-[#55FFCB]/20 rounded-xl relative overflow-hidden group">
                  ...
                  <div className="absolute w-full h-43 inset-0 bg-[#0A0B0B]/25 group-hover:bg-[#0A0B0B]/5"></div>
                  <div className="w-full h-full flex flex-col px-4 py-2 rounded-b-xl bg-[#2A2A2A]">
                    ...
                    <div className="w-auto grid  mt-3 md:grid-cols-2 gap-2">
                      {data.skill.map((data) => (
                        <p className="border-1 bg-[#2E5046] border-[#55FFCB]/20 px-5 text-[#55FFCB] text-[10px] py-1 text-center font-semibold rounded-full">{data}</p>
                      ))}
                    </div>
          ...
          <div className="w-full mt-5 p-5 border-1 border-[#55FFCB]/20 rounded-xl bg-[#2A2A2A] grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-5">
            {trainer_stats.map((data, index) => (
              <div className="flex flex-col p-3 items-center">
                    ...
                    <p className="body mt-2 font-semibold text-white/70 text-[12px]">
                      {data.text}
                    </p>
      ...
      <div className="w-full p-15 flex flex-col items-center bg-[#242424]">
          <p className="text-[12px] font-bold text-[#55FFCB]">SUCCESS STORIES</p>
          <h3 className="text-4xl heading leading-tight text-center font-bold mt-3 text-white">REAL PEOPLE.<br /> <span className="text-[#55FFCB]">REAL RESULTS.</span></h3>
          <p className="w-[50%] text-center text-[13px] text-white/80 mt-5">
          ...
          <div className="p-5 mt-5  w-full border-1  rounded-2xl bg-[#2A2A2A] border-[#55FFCB]/20">
            <div className="relative rounded-2xl p-3 flex flex-col md:flex-row gap-6 items-center">
                <div className="relative w-1/2 h-[350px] rounded-xl">
                  <Image  src={item.image} alt={item.name} fill  className="object-cover rounded-xl"/>
                   <span className="absolute top-4 left-4 bg-[#55FFCB] text-black text-[11px] font-semibold px-5 py-1.5 rounded-full">
                    TRANSFORMATION
                  </span>
          ...
          <div className="w-full py-5 mt-10 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5">
